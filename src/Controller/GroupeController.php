...
class GroupeController extends AbstractController
{
    ...
    #[Route('/{seqgroupe}', name: 'app_groupe_show', methods: ['GET'])]
    ...
    #[Route('/{seqgroupe}/edit', name: 'app_groupe_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{seqgroupe}', name: 'app_groupe_delete', methods: ['POST'])]
    public function delete(Request $request, Groupe $groupe, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$groupe->getSeqgroupe(), $request->request->get('_token'))) {
